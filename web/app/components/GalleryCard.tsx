...
export default function GalleryCard({mainImage, galleryImages, title, slug}: any) {
    return (
        <>
                ...
                <div className="mx-auto sm:px-2">
                    <div className="shadow-xl sm:overflow-hidden">
                        <div className="absolute inset-0 overflow-hidden rounded-lg">
                            <ProgressiveSanityImage mainImage={mainImage} hf={16} width={1080} />
                        ...
                        <div className="relative px-2 sm:px-0 pt-48 pb-4 lg:mt-8 mx-auto">
                            ...
                            <Link to={`/photos/${slug.current}`}><span className="text-slate-50 text-5xl">{title.toLowerCase()}</span></Link>
